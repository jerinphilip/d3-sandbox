...
var random_sample = function(population, size) {
    var shuffled = population.slice(0), i = population.length, temp, index;
    while (i--) {
...
var display = function(root, data){
    ...
    // Append src and tgt
    div.append("div").text("[src] " + clean(data["src"]));
    div.append("div").text("[tgt] " + clean(data["tgt"]));

    // Operate and append hypothesis
